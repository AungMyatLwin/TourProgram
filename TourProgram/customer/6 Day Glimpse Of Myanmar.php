...
<html lang="en">
<head>
<title>6 Day Glimpse Of Myanmar</title>
<meta charset="utf-8">
        ...
        <ul class="sf-menu">
          ...
          <li class="current"> <a href="Tourprogram.php">Tour Program</a>
         		<ul class="tp">
                    ...
                    <li class="current"><a href="6 Day Glimpse Of Myanmar.php">6 Day Gllimpse Of Myanmar</a></li>
                    ...
                    <li><a href="Day Tour.php">Day Tour</a>
                    	<ul class="tp">
                            ...
                            <li><a href="Innwa (AVA) – Sagaing Day Tour.ph">Innwa - Sagaing</a></li>
...
<section id="content">
	   <div>
    	<a href="6 Day Glimpse Of Myanmar.php"><h2 class="p3"><span class="new">&nbsp; &nbsp;6 Day Glimpse Of Myanmar</span></h2></a>
    </div>
     <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
      <div class="container_12">
        <article class="a1">
          <div class="wpb_wrapper">
          <h5><strong>Yangon- Bagan – Mt.Popa –  Yangon</strong></h5>
          <div class="content-box">
          <p><strong>
         Day 01: Yangon Arrival & Sightseeing<br>
		Day 02: Yangon – Bagan by flight<br>
		Day 03: Bagan sightseeing<br>
		Day 04: Bagan –Mt.Popa –  Yangon by flight<br>
		Day 05: Yangon Sightseeing & Departure<br>
         </strong>
          </p3>
            </div>
            </div>
       ...
       <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Day 2&nbsp;&nbsp; Yangon – Bagan by Flight</strong></h5></div> 
...
In the afternoon, after a visit to lacquer ware workshops; continue to Manuha Temple built by exile King Manuha; Nanphaya, said to have been the residence of King Manuha; Ananda Temple, architectural masterpiece and Oak-Kyaung monastery decorated with multi-color mural paintings. Enjoy the breathtaking sunset from one of the temple of Bagan. Overnight at the hotel in Bagan.
           ...
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            ...
            <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/Shwezigone.jpg" class="lightbox-image"><img src="../proj image/Shwezigone.jpg" alt="" width="268px" height="150px" ></a>Shwezigone</figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Htilominlo-Temple.jpg" class="lightbox-image">  <img src="../proj image/Htilominlo-Temple.jpg" alt="" width="268px" height="150px"></a>Htilominlo Temple</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/Manuha.jpg" class="lightbox-image"><img src="../proj image/Manuha.jpg" alt="" width="268px" height="150px"></a>Manuha</figure>
           ...
           <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/Bagaya-Monastery.jpg" class="lightbox-image"><img src="../proj image/Bagaya-Monastery.jpg" alt="" width="268px" height="150px" ></a>Bagaya Monastery</figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Mahamuni-Pagoda.jpg" class="lightbox-image">  <img src="../proj image/Mahamuni-Pagoda.jpg" alt="" width="268px" height="150px"></a>Mahamuni</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/Kuthodaw-Pagoda.jpg" class="lightbox-image"><img src="../proj image/Kuthodaw-Pagoda.jpg" alt="" width="268px" height="150px"></a>Phwar Saw Village</figure>
          ...
          <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Day 4&nbsp;&nbsp; Mandalay – Heho (Inle Lake) by Flight</strong></h5></div> 
           ...
           <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/Phaungdawoo-Pagoda.jpg" class="lightbox-image"><img src="../proj image/Phaungdawoo-Pagoda.jpg" alt="" width="268px" height="150px" ></a>Phaungdawoo Pagoda</figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Phaungdawoo-Pagoda2.jpg" class="lightbox-image">  <img src="../proj image/Phaungdawoo-Pagoda2.jpg" alt="" width="268px" height="150px"></a>Phaungdawoo Pagoda</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/Inle-Lake1.jpg" class="lightbox-image"><img src="../proj image/Inle-Lake1.jpg" alt="" width="268px" height="150px"></a>
               Inle Lake</figure>
           ...
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Day 5&nbsp;&nbsp; Inle – Indein Sightseeing and Yangon by Flight</strong></h5></div> 
                
                
                <div class=""><div class="content-box"><p align="justify">
            After breakfast at the hotel, visit floating market which is a 5day rotation market most fascinating to watch the daily life of the minorities and their activities. Continue our excursion by motorized boat to Indein pagoda complex, in the south-west of the lake. The boat leaves the lake and enters a narrow canal with a beautiful natural environment to continue to a small Pa O tribe village. From the village, follow an old covered path to a 13th century monastery and the very impressive ruins of hundreds of ancient pagodas, some hidden in the vegetation. The main stupa-area on the top of the hill offers breathtaking views over the surrounding mountains and down to the valley and the lake in the far distance. Return to jetty and proceed to heho airport for your return flight to Yangon this afternoon. Upon arrival at Yangon airport, transfer to your hotel and overnight at the hotel in Yangon.
              </p></div></div>
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
           <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/floating-market-inle.jpg" class="lightbox-image"><img src="../proj image/floating-market-inle.jpg" alt="" width="268px" height="150px" ></a>Floating Market Inle</figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/boat.jpg" class="lightbox-image">  <img src="../proj image/boat.jpg" alt="" width="268px" height="150px"></a>Indain Village</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/Indein-Pagaoda.jpg" class="lightbox-image"><img src="../proj image/Indein-Pagaoda.jpg" alt="" width="268px" height="150px"></a>Indein Pagoda/figure>
              
            </div>
          </div>
   <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Day 6&nbsp;&nbsp; Yangon Sightseeing & Departure</strong></h5></div> 
