...
<div class="main-indents container-fluid">
         		...
         		<ul class="tp">
                    ...
                    <li ><a href="Optional Tour.php">Optional Tour</a>
                    	<ul class="tp ">
                            ...
                            <li><a href="Balloons Over Inle.php">Balloons Over Inle</a></li>
 ...
 <!-- slider-->
    ...
    <section id="content">
	   <div>
    	<a href="Pyin Oo Lwin Day Tour.php"><h2 class="p3"><span class="new">&nbsp; &nbsp;Pyin Oo Lwin Day Tour</span></h2></a>
    </div>
      ...
      <div class="container_12">
        <article class="a1">
          <div class="wpb_wrapper">
            ...
            <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Pyin Oo Lwin Day Tour</strong></h5></div> 
                
                
                <div class="a1"><div class="content-box"><p align="justify">Pick up from your hotel and set off on a one and half hour drive to Pyin Oo Lwin (formerly known as Maymyo, named after Colonel May, a veteran of the Indian Mutiny and commander of the Bengal Regiment temporarily stationed here in 1887). Located a good 1000m above sea level, this former British hill station is home to a range of red-brick colonial buildings, and also famous for its delicious coffee. While ascending into the Shan mountains towards this old colonial holiday spot, make sure to stop to enjoy the picturesque views and visit a local vendor selling fresh strawberries and jams. When you arrive you will have the chance to explore the area with its local market and cafes downtown, before continuing on to the nearby Botanical Gardens, founded in 1915 by a British botanist, which cover an area of more than 170 acres of land and 70 acres of water. Stop to have lunch in the garden at December Farms. Make sure to try one of their delicious homemade yogurts, ice creams or milkshake for dessert. After lunch, you will also have the option of riding in a horse-drawn cart to the Thiri Myaing, formerly known as the Candacraig, a beautiful colonial mansion which was built in 1904 by the British Bombay Burma Timber Company for their expatriates. Return back to Mandalay in the early evening.</p></div></div>
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
           
            <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/botanicalgardens.jpg" class="lightbox-image"><img src="../proj image/botanicalgardens.jpg" alt="" width="268px" height="150px" ></a>Botanical Gardens </figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/botanicalgardens1.jpg" class="lightbox-image">  <img src="../proj image/botanicalgardens1.jpg" alt="" width="268px" height="150px"></a>Botanical Gardens</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/Thiri-Myaing.jpg" class="lightbox-image"><img src="../proj image/Thiri-Myaing.jpg" alt="" width="268px" height="150px"></a>Thiri Myaing</figure>
