         		...
         		<ul class="tp">
                    ...
                    <li class="current"><a href="Day Tour.php">Day Tour</a>
                    	<ul class="tp">
                            ...
                            <li class="current"><a href="Mt. Poppa Day Tour.php">Mt.Poppa</a></li>
...
<div class="mp-slider container-fluid">
   ...
   <section id="content">
	   <div>
    	<a href="Mt. Poppa Day Tour.php"><h2 class="p3"><span class="new">&nbsp; &nbsp;Mt. Poppa Day Tour</span></h2></a>
    </div>
      ...
      <div class="container_12">
        <article class="a1">
          <div class="wpb_wrapper">
            ...
            <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Mt. Poppa Day Tour</strong></h5></div> 
                
                
                <div class="a1"><div class="content-box"><p align="justify">Pick up from your hotel and drive to Mt. Popa, an extinct volcano known as the abode of the legendary nats (naughty spirits!); a one hour drive. Here a temple complex sits perched atop the summit where, for the energetic, there is time to climb the 777 steps to the top of the hill or, for the less energetic, an opportunity to join the local pilgrims and participate in the festivities at the base. Mt. Popa is a natural place to learn about the nat, or spirit, as people traditionally believe that the custom of nat worship started here and it is still practiced here as although Myanmar is a Buddhist country they also practice spirit worship in the belief that it will bring about prosperity. Depart from Mt. Popa, return to Bagan and proceed to your hotel.</p></div></div>
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
           
            <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/mt-popa.jpg" class="lightbox-image"><img src="../proj image/mt-popa.jpg" alt="" width="268px" height="150px" ></a>Mt.Poppa</figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Mt.Popa_.jpg" class="lightbox-image">  <img src="../proj image/Mt.Popa_.jpg" alt="" width="268px" height="150px"></a>Mt.Poppa</figure>
