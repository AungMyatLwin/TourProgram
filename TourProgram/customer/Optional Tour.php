      ...
      <div class="container_12">
        ...
        <article class="a2">
          ...
          <div class="wrapper">
           ...
           <div class="col-1">
              <figure class="img-box"> <a href="Trekking In Pindaya.php" class="" data-gal=""><img src="../proj image/trekking-pindaya.jpg" alt="" width="300px" height="150px" </a> </figure>
              <div class="gallery-meta"> <a href="Trekking In Pindaya.php" class="gallery-name">Trekking In Pindaya</a></div>
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"> <a href="Balloons Over Inle.php " class="" data-gal=""> <img src="../proj image/balloon-over-inle.jpg" alt="" width="300px" height="150px"> </a> </figure>
              <div class="gallery-meta"> <a href="Balloons Over Inle.php" class="gallery-name">Balloons Over Inle</a></div>
            </div>
            <div class="col-2">
               <figure class="img-box"> <a href="Red Mountain.php" class="" data-gal=""> <img src="../proj image/red-mountain-banner.jpg" alt="" width="300px" height="150px"> </a> </figure>
              <div class="gallery-meta"> <a href="Red Mountain.php" class="gallery-name">Red Mountain Tour</a></div>
            </div>
          
            <div class="col-1">
              <figure class="img-box"> <a href="Elephant Sanctuary.php " class="" data-gal=""><img src="../proj image/elephant1.jpg" alt="" width="300px" height="150px" </a> </figure>
              <div class="gallery-meta"> <a href="Elephant Sanctuary.php" class="gallery-name">Myanmar's Family-Run Elephant Sanctuary</a></div>
