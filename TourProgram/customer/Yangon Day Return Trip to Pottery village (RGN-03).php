...
<div class="mp-slider container-fluid">
 ...
 <section id="content">
	   <div>
    	<a href="Yangon Day Return Trip to Pottery village (RGN-03).php"><h2 class="p3"><span class="new">&nbsp; &nbsp; Yangon Day Return Trip to Pottery village (RGN-03)</span></h2></a>
    </div>
