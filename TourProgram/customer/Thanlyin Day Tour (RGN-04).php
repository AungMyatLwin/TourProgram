...
<div class="mp-slider container-fluid">
   ...
   <section id="content">
	   <div>
    	<a href="Thanlyin Day Tour (RGN-04).php"><h2 class="p3"><span class="new">&nbsp; &nbsp; Thanlyin Day Tour (RGN-04)</span></h2></a>
    </div>
      ...
      <div class="container_12">
        <article class="a1">
          ...
          <div class="content-box">
            ...
            <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Thanlyin Day Tour (RGN-04)</strong></h5></div> 
           ...
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            ...
            <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/Kyauk-Tan.jpg" class="lightbox-image"><img src="../proj image/Kyauk-Tan.jpg" alt="" width="268px" height="150px" ></a>Kyaik-Khauk Pagoda </figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Kyaik-Khauk.jpg" class="lightbox-image">  <img src="../proj image/Kyaik-Khauk.jpg" alt="" width="268px" height="150px"></a>Kyauk-Tan Pagoda</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/church.jpg" class="lightbox-image"><img src="../proj image/church.jpg" alt="" width="268px" height="150px"></a>Old Portuguese</figure>
