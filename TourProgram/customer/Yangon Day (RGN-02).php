...
<div class="mp-slider container-fluid">
   ...
   <section id="content">
	   <div>
    	<a href="Yangon Day Tour with Circular Train Ride (RGN-02).php"><h2 class="p3"><span class="new">&nbsp; &nbsp; Yangon Day Tour with Circular Train Ride (RGN-02)</span></h2></a>
    </div>
      ...
      <div class="container_12">
        <article class="a1">
          ...
          <div class="content-box">
            ...
            <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Yangon Day Tour with Circular Train Ride (RGN-02)</strong></h5></div> 
           ...
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            ...
            <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/Yangon-Sule-2.jpg" class="lightbox-image"><img src="../proj image/Yangon-Sule-2.jpg" alt="" width="268px" height="150px" ></a>Yangon Railway Station </figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Yangon-Sule-1.jpg" class="lightbox-image">  <img src="../proj image/Yangon-Sule-1.jpg" alt="" width="268px" height="150px"></a>Circular Train</figure>
            ...
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/Yangon-3.jpg" class="lightbox-image"><img src="../proj image/Yangon-3.jpg" alt="" width="268px" height="150px"></a>Bogyoke Aung San(Scot)Market</figure>
