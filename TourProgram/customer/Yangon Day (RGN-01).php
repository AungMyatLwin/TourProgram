...
<div class="mp-slider container-fluid">
  ...
  <section id="content">
	   <div>
    	<a href="Yangon Day (RGN-01).php"><h2 class="p3"><span class="new">&nbsp; &nbsp; Yangon Day (RGN-01)</span></h2></a>
    </div>
      ...
      <div class="container_12">
        <article class="a1">
          ...
          <div class="content-box">
            ...
            <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Yangon Day Tour(RGN-01)</strong></h5></div> 
           ...
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            ...
            <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/shwedagone.jpg" class="lightbox-image"><img src="../proj image/shwedagone.jpg" alt="" width="268px" height="150px" ></a>Shawedagon Pagoda </figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Yangon-Sule-1.jpg" class="lightbox-image">  <img src="../Han Win Hlaing/.../proj image/Yangon-Sule-1.jpg" alt="" width="268px" height="150px"></a>Mahabandoola Park</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/chaukhtetkyi.jpg" class="lightbox-image"><img src="../proj image/chaukhtetkyi.jpg" alt="" width="268px" height="150px"></a>Chaukhetgyi Reclining Buddha</figure>
