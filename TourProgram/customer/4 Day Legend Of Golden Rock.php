...
<html lang="en">
<head>
<title>4 Day Legend Of Golden Rock</title>
<meta charset="utf-8">
        ...
        <ul class="sf-menu">
          ...
          <li class="current"> <a href="Tourprogram.php">Tour Program</a>
         		<ul class="tp">
                    ...
                    <li class="current"><a href="4 Day Legend Of Golden Rock.php">4 Day Legend Of Golden Rock</a></li>
...
<section id="content">
	   <div>
    	<a href="4 Day Legend Of Golden Rock.php"><h2 class="p3"><span class="new">&nbsp; &nbsp;4 Day Legend Of Golden Rock</span></h2></a>
    </div>
     <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
      <div class="container_12">
        <article class="a1">
          <div class="wpb_wrapper">
          <h5><strong>Yangon- Kyaikhtiyo (Golden Rock) – Bago – Yangon</strong></h5>
          <div class="content-box">
          <p><strong>
          	Day 01: Yangon Arrival & Sightseeing <br>
			Day 02: Yangon – Kyaikhtiyo (Golden Rock) by car<br>
			Day 03: Kyaikhtiyo (Golden Rock) – Bago – Yangon by car<br>
			Day 04: Yangon Sightseeing & Departure<br></strong>
          </p3>
            </div>
            </div>
            <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
       ...
       <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Day 2&nbsp;&nbsp; Yangon – Kyaikhtiyo (Golden Rock) by Car</strong></h5></div> 
           ...
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            ...
            <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/Kyaik-Hti-Yo.jpg" class="lightbox-image"><img src="../proj image/Kyaik-Hti-Yo.jpg" alt="" width="268px" height="150px" ></a>Kyaik Hti Yo</figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Kyaik-Hti-Yo-2.jpg" class="lightbox-image">  <img src="../proj image/Kyaik-Hti-Yo-2.jpg" alt="" width="268px" height="150px"></a>Kyaik Hti Yo</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/golden-rock.jpg" class="lightbox-image"><img src="../proj image/golden-rock.jpg" alt="" width="268px" height="150px"></a>Kyaik Hti Yo</figure>
           ...
           <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/shwethalaung.jpg" class="lightbox-image"><img src="../proj image/shwethalaung.jpg" alt="" width="268px" height="150px" ></a>ShweThaLaung</figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Kyatkatwine-Monastery-.jpg" class="lightbox-image">  <img src="../proj image/Kyatkatwine-Monastery-.jpg" alt="" width="268px" height="150px"></a>Kyatkatwine Monastery</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/Shwemawdaw-Pagoda.jpg" class="lightbox-image"><img src="../proj image/Shwemawdaw-Pagoda.jpg" alt="" width="268px" height="150px"></a>Shwemawdaw Pagoda</figure>
