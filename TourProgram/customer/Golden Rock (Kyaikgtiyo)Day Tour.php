...
<div class="main-indents container-fluid">
  <div class="main container-fluid">
         		...
         		<ul class="tp">
                    ...
                    <li class="current"><a href="Day Tour.php">Day Tour</a>
                    	<ul class="tp">
                            ...
                            <li class="current"><a href="Golden Rock (Kyaikgtiyo)Day Tour.php">Golden Rock (Kyaikhtiyoe)</a></li>
    ...
    <!-- Slider -->
<div class="mp-slider container-fluid">
    ...
    <section id="content">
	   <div>
    	<a href="Golden Rock (Kyaikgtiyo)Day Tour.php"><h2 class="p3"><span class="new">&nbsp; &nbsp;Golden Rock (Kyaikgtiyo)Day Tour</span></h2></a>
    </div>
      ...
      <div class="container_12">
        <article class="a1">
          <div class="wpb_wrapper">
            ...
            <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Golden Rock (Kyaikgtiyo)Day Tour</strong></h5></div> 
                
                
                <div class="a1"><div class="content-box"><p align="justify">This morning around 6 a.m., we will hit the road to Golden Rock. On the way, we can pause our drive for a short visit tothe Taukkyan War Cemetery which is a cemetery for Allied soldiers from the British Commonwealth who died in battle in Burma during the Second World War. The cemetery is in Taukkyan town, about 25 kilometres north of Yangon on Pyay Road. Continue drive to the Kinpunbase camp of Golden Rock, Kyaikhtiyo (a small Pagoda, insignificant in size but unique in its position). The small stupa sits on top of a massive rock which is completely covered with gold leaf and delicately balanced on the edge of the cliff. Upon arrival at base camp proceed to the next camp, called Yathaetaung, by open truck, about an hour’s mountain drive. Take a light trek or you sit on the easy-chair (own expense) carried by four men to the Golden Rock along the steep concrete footpath. Stop at the roadside shops to view some unusual products that come from the local jungle. Continue with a short walk to a small cave which looks like the beak of a crow. This evening around 3 p.m., drive down to the base camp. Then, drive back to Yangon.</p></div></div>
          <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
          <div class="wrapper">
            <div class="wrapper">
              <div class="col-1">
                <figure class="img-box"><a href="../proj image/golden-rock.jpg" class="lightbox-image"><img src="../proj image/golden-rock.jpg" alt="" width="268px" height="150px" ></a>Kyaikhtiyo(Golden Rock) </figure>
              </div>
              <div class="col-1">
                <figure class="img-box"><a href="../proj image/Kyaik-Hti-Yo-2.jpg" class="lightbox-image"> <img src="../proj image/Kyaik-Hti-Yo-2.jpg" alt="" width="268px" height="150px"></a>Kyaikhtiyo(Golden Rock)</figure>
              </div>
