         		...
         		<ul class="tp">
                    ...
                    <li class="current"><a href="Day Tour.php">Day Tour</a>
                    	<ul class="tp">
                            ...
                            <li class="current"><a href="Mandalay Day Tour.php">Mandalay</a></li>
...
<div class="mp-slider container-fluid">
   ...
   <section id="content">
	   <div>
    	<a href="Mandalay Day Tour.php"><h2 class="p3"><span class="new">&nbsp; &nbsp;Mandalay Day Tour</span></h2></a>
    </div>
      ...
      <div class="container_12">
        <article class="a1">
          <div class="wpb_wrapper">
            ...
            <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
            <div class="wpb_wrapper">
            	<h5><strong>Mandalay Day Tour</strong></h5></div> 
                
                
                <div class="a1"><div class="content-box"><p align="justify">This morning, you will be taken for a sightseeing tour of Mandalay which includes Mahanumi, a life like Buddha image. Mandalay is the last capital of Myanmar and that make her to be the best place to see all the traditional arts and crafts. Start visiting gold leaf making work-place and see how the gold leaf is being made by hand in a traditional way. Continue visit the Old Palace grounds; Kuthodaw Pagoda, known as the world’s largest book for its 729 marble slabs inscribed with the Buddha’s Doctrine; Golden Palace Monastery, noted for its exquisite wood carvings and enjoy the panoramic view of the city from Mandalay Hill. Transfer back to your hotel.</p></div></div>
           <div class="vc_empty_space" style="height: 20px"><span class="vc_empty_space_inner"></span></div>
           
            <div class="wrapper">
            <div class="col-1">
              <figure class="img-box"><a href="../proj image/Bagaya-Monastery.jpg" class="lightbox-image"><img src="../proj image/Bagaya-Monastery.jpg" alt="" width="268px" height="150px" ></a>Golden Palace Monastery</figure>
             
              
            </div>
            
            <div class="col-1">
             <figure class="img-box"><a href="../proj image/Mahamuni-Pagoda.jpg" class="lightbox-image">  <img src="../proj image/Mahamuni-Pagoda.jpg" alt="" width="268px" height="150px"></a>Mahamuni Buddha</figure>
             
            </div>
            <div class="col-2">
               <figure class="img-box"><a href="../proj image/Kuthodaw-Pagoda.jpg" class="lightbox-image"><img src="../proj image/Kuthodaw-Pagoda.jpg" alt="" width="268px" height="150px"></a>Kuthodaw Pagoda</figure>
