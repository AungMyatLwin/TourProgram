...
<section id="content">
	   <div>
    	<a href="Red Mountain.php"><h2 class="p3"><span class="new">RED MOUNTAIN</span></h2></a>
    </div>
        ...
        <article class="a1">
          ...
          <h5>Blossoming vineyards</h5>
            ...
            <div class="content-box">
              <figure class="img-box"><a href="../proj image/red-mountain2.jpg" class="lightbox-image"><img src="../proj image/red-mountain2.jpg" alt="" width="268px" height="150px" ></a></figure>
                ...
                <div class=""><div class="content-box"><p>Located on the side of the famous Inle Lake, in the southern Shan State of the Union of Myanmar, the Red Mountain Estate produces the best wines of the country. Since the beginning, the wines are produced with locally grown grapes. All of the 400,000 plants have been imported from France and Spain, and the variety chosen after experimentation.</p></div></div>
          ...
          <h5>Blossoming vineyards</h5>
            ...
            <div class="wrapper">
            <div class="content-box">
              <figure class="img-box"><a href="../proj image/red-mountain3.jpg" class="lightbox-image"><img src="../proj image/red-mountain3.jpg" alt="" width="268px" height="150px" ></a></figure>
                ...
                <div class=""><div class="content-box"><p>One of the main reasons that makes people make the Red Mountain tours is the need to taste the various Washington wine that are prepared by the world’s leading wineries. Everyone loves wine tasting at the Red Mountain because a variety of experiences shall be enjoyed.</p></div></div>
